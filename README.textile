...
* No Rails? ... No! because being rails rockstar, you are encouraged to grab latest "rails":http://github.com/rails/rails/tree/master and freeze  rails version in your specific apps.
* You can keep installing your favorite gems , libs , or native dependencies (with MacPorts, eg. graphviz , imagemagick) and all of this can be instantly backed up by grabbing one single directory. Hence if your system crashes or you are moving to different computer , your personal development stack is restored with no surprises.    
