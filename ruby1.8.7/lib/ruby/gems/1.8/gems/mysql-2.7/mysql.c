...
void Init_mysql(void)
{
    ...
    rb_define_const(eMysql, "ER_CONST_EXPR_IN_PARTITION_FUNC_ERROR", INT2NUM(ER_CONST_EXPR_IN_PARTITION_FUNC_ERROR));
    ...
    rb_define_const(eMysql, "ER_SLAVE_AMBIGOUS_EXEC_MODE", INT2NUM(ER_SLAVE_AMBIGOUS_EXEC_MODE));
