...
module Config
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.8/i686-darwin9.6.0")
  DESTDIR = '' unless defined? DESTDIR
  CONFIG = {}
  CONFIG["DESTDIR"] = DESTDIR
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/parolkar/binaries/ruby1.8.7")
  CONFIG["EXEEXT"] = ""
  ...
  CONFIG["exec_prefix"] = "$(DESTDIR)/Users/parolkar/binaries/ruby1.8.7"
  ...
  CONFIG["host"] = "i686-apple-darwin9.6.0"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_os"] = "darwin9.6.0"
  CONFIG["target"] = "i686-apple-darwin9.6.0"
  CONFIG["target_cpu"] = "i686"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_os"] = "darwin9.6.0"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["arch"] = "i686-darwin9.6.0"
  CONFIG["sitearch"] = "i686-darwin9.6.0"
  CONFIG["sitedir"] = "$(libdir)/ruby/site_ruby"
  CONFIG["vendordir"] = "$(prefix)/lib/ruby/vendor_ruby"
  CONFIG["configure_args"] = " '--prefix=/Users/parolkar/binaries/ruby1.8.7' '--exec-prefix=/Users/parolkar/binaries/ruby1.8.7'"
